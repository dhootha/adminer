...
function get_users_detail($field){
	//$user_id = $this->user_model->find($field);
	...
	// if($user_id!=""){
		...
		// //edited by Deepak Kakran on 30th June, 2013 00:46 AM IST
		// $user_detail_query=$ci->user_model->find($user_id);
		// $user_detail=$user_detail_query->get();
		// //$user_detail=$ci->user_model->find($user_id);
